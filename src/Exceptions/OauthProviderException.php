...
namespace ManualpracticeSampleApiLib\Exceptions;
...
class OauthProviderException extends ApiException
{
    ...
    /**
     * @param string $reason
     * @param \ManualpracticeSampleApiLib\Http\HttpRequest $request
     * @param \ManualpracticeSampleApiLib\Http\HttpResponse $response
     * @param string $error
     */
    public function __construct(
        string $reason,
        \ManualpracticeSampleApiLib\Http\HttpRequest $request,
        \ManualpracticeSampleApiLib\Http\HttpResponse $response,
        string $error
    ) {
     ...
     * @required
     * @maps error
     * @factory \ManualpracticeSampleApiLib\Models\OauthProviderError::checkValue
     */
